/*
 * This challenge computers and display the total charges for a hospital stay 
...
public class HospitalCharges {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("Do you have another patinet? (y/n)");
            response = in.next();
    ...
    public static void printTotal(double totalCost){
        System.out.printf("The total cost ofr this patient is: $%6.2f", totalCost);
    }
